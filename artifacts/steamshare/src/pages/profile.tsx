...
export default function Profile() {
  ...
  const { data: accounts, isLoading: accountsLoading } = useGetUserAccounts(
    ...
    {
      query: {
        queryKey: getGetUserAccountsQueryKey(id),
        enabled: !!id && !isNaN(id),
        retry: false,
      },
    },
  ...
  const canManage =
    me && (me.isAdmin || (me as any).isModerator) && me.id !== id;
            ...
            <div className="flex-1 text-center sm:text-left min-w-0">
              ...
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 text-xs text-muted-foreground mb-3">
                ...
                {user.badgeName && (
                  <Badge
                    variant="outline"
                    className="text-primary border-primary/30 bg-primary/10 text-xs flex items-center gap-1"
                  >
              ...
              {canManage && (
                <>
                  {!user.isBanned ? (
                    <Dialog open={banOpen} onOpenChange={setBanOpen}>
                      ...
                      <DialogContent className="bg-card border-border max-w-sm">
                        <DialogHeader>
                          <DialogTitle>Ban {displayedName}</DialogTitle>
                        </DialogHeader>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="gap-1.5 text-green-600 border-green-600/30"
                  ...
                  {(me.isAdmin || (me as any).isModerator) && (
                    <a
                      href={`https://admin.steamfamily.xyz?tab=users&id=${id}`}
                      target="_blank"
